...
namespace Laba10part3
{
        ...
        {
            static string[] PlaceStudy = { "ПНИПУ", "ПГНИУ", "Педагогический университет", "ПГМУ", "ПГФА", "РЭУ"};
        ...
        {
            // Мы используем только поля базового класса Person для хеширования
        ...
        // Свойство, возвращающее объект базового класса Person
